...
if(USE_SANITIZER)
  ...
  if(UNIX)
    ...
    elseif("${USE_SANITIZER}" MATCHES "([Aa]ddress)")
      append("-fno-optimize-sibling-calls -fsanitize-address-use-after-scope" CMAKE_C_FLAGS CMAKE_CXX_FLAGS)
      message(STATUS "Building with Address sanitizer")
      append("-fsanitize=address" CMAKE_C_FLAGS CMAKE_CXX_FLAGS)
    elseif(USE_SANITIZER MATCHES "([Mm]emory([Ww]ith[Oo]rigins)?)")
      append("-fno-optimize-sibling-calls -fsanitize-memory-track-origins=2" CMAKE_C_FLAGS CMAKE_CXX_FLAGS)
